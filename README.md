[![Git Anti Virus Scan](https://github.com/DRincs-Productions/daz-assert-clothes/actions/workflows/antivirus.yml/badge.svg)](https://github.com/DRincs-Productions/daz-assert-clothes/actions/workflows/antivirus.yml)

## How to work
Before you start creating a scene check the [wiki](https://github.com/DRincs-Productions/daz-assert-clothes/wiki) to see if there is an element best suited for you.
